...
public class ExcelParserService : IExcelParserService
{
    ...
    public async Task<Tournament> ParseTournamentAsync(Stream excelStream, string fileName)
    {
        try
        {
            ...
            tournament.Pairs = ConvertGamesToPairCentricStructure(games, tournament.Id);
    ...
    /// </summary>
    private List<TournamentPair> ConvertGamesToPairCentricStructure(List<Game> games, string tournamentId)
    {
