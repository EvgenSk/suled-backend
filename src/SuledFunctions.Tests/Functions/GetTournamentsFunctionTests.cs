...
public class GetTournamentsFunctionTests
{
    ...
    {
        var handlerMock = new Mock<IGetTournamentsRequestHandler>();
        ...
        var function = new GetTournamentsFunction(handlerMock.Object);
    ...
    private static Mock<HttpRequestData> CreateMockRequest()
    {
        ...
        requestMock.Setup(r => r.Url).Returns(new Uri("http://localhost:7071/api/tournaments"));
        return requestMock;
    }
}
